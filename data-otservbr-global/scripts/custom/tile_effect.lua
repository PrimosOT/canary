local effects = {
	...
	{position = Position(32260, 34000, 7), text = 'HUNTES!', effect = 71}, -- editado novo
	...
	{position = Position(32269, 34000, 7), text = 'BOSSES!', effect = 74}, -- editado novo
	...
	{position = Position(32267, 34000, 7), text = 'FORGE!', effect = 54}, -- editado novo
