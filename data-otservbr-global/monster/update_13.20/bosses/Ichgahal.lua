...
monster.attacks = {
	...
	{ name ="combat", interval = 1000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -700, maxDamage = -1500, length = 12, spread = 3, effect = 249, target = false },
	...
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -900, maxDamage = -2500, length = 6, spread = 2, effect = CONST_ME_FIREAREA, target = false },
