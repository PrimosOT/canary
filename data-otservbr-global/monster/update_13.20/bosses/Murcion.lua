...
monster.attacks = {
	...
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1900, radius = 4, effect = CONST_ME_SMALLCLOUDS, target = false },
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -500, maxDamage = -1900, range = 4, radius = 4, shootEffect = 31, effect = 248, target = true },
