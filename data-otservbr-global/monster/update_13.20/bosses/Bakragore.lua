...
monster.loot = {
	...
	{ name = "Big Seller Token", chance = 15880 , minCount = 1, maxCount = 5},
...
monster.attacks = {
	...
	{ name ="combat", interval = 3000, chance = 35, type = COMBAT_ICEDAMAGE, minDamage = -900, maxDamage = -2900, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 243, target = true },
	{ name ="combat", interval = 2000, chance = 13, type = COMBAT_DEATHDAMAGE, minDamage = -700, maxDamage = -1800, length = 8, spread = 3, effect = 252, target = false },
