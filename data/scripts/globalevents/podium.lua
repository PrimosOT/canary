...
local positions = {
    top1 = Position(32265, 34005, 7),
    top2 = Position(32264, 34005, 7),
    top3 = Position(32266, 34005, 7)
}

-- Initialize GlobalStorage.Podium
GlobalStorage.Podium = GlobalStorage.Podium or { One = 0, Two = 0, Three = 0 }
