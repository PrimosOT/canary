...
Karin.isBadTileToDamage = function(v83, v84)
	return (v84 == nil) or (v84:getGround() == nil) or v84:hasProperty(TILESTATE_NONE) or (Item(v84:getThing()) and not isMoveable(v84:getThing())) or v84:hasFlag(TILESTATE_PROTECTIONZONE);
end;
Karin.isBadTileWithoutPZ = function(v85, v86)
	return (v86 == nil) or (v86:getGround() == nil) or v86:hasProperty(TILESTATE_NONE) or (Item(v86:getThing()) and not isMoveable(v86:getThing())) or v86:getTopCreature();
end;
Karin.isBadTile = function(v87, v88)
	return (v88 == nil) or (v88:getGround() == nil) or v88:hasProperty(TILESTATE_NONE) or (Item(v88:getThing()) and not isMoveable(v88:getThing())) or v88:getTopCreature() or v88:hasFlag(TILESTATE_PROTECTIONZONE);
end;
